...
export class DiffAPICommand {
	...
	public static execute(executor: ICommandsExecutor, left: URI, right: URI, label: string, options?: vscode.TextEditorOpenOptions): Promise<any> {
...
export class OpenAPICommand {
	...
	public static execute(executor: ICommandsExecutor, resource: URI, columnOrOptions?: vscode.ViewColumn | vscode.TextEditorOpenOptions, label?: string): Promise<any> {
...
export class OpenWithAPICommand {
	...
	public static execute(executor: ICommandsExecutor, resource: URI, viewType: string, columnOrOptions?: vscode.ViewColumn | vscode.TextEditorOpenOptions): Promise<any> {
		let options: ITextEditorOptions | undefined;
		let position: EditorViewColumn | undefined;
